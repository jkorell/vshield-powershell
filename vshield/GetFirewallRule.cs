...
//Get-FirewallRule -Client $connect -InternalPortGroupMofId "dvportgroup-2735" | Set-FirewallRule -Client $connect -InternalPortGroupMofId "dvportgroup-2735" -DstIp "10.53.2.123" -DstPort "445" -SrcIp "any" -SrcPort "any'