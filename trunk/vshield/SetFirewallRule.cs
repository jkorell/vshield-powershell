...
namespace vshield
{
    ...
    public class SetFirewallRule : Cmdlet
    {
        ...
        private VShieldEdgeConfig SetObject()
        {
            ...
            fwconf.FirewallConfig[0].action = _Action;
            fwconf.FirewallConfig[0].direction = _Direction;
            fwconf.FirewallConfig[0].protocol = _Protocol;
            fwconf.FirewallConfig[0].destinationIpAddress.ipAddress = _DstIp;
            fwconf.FirewallConfig[0].destinationPort.port = _DstPort;
            fwconf.FirewallConfig[0].sourceIpAddress.ipAddress = _SrcIp;
            fwconf.FirewallConfig[0].sourcePort.port = _SrcPort;
            return fwconf;
        }
